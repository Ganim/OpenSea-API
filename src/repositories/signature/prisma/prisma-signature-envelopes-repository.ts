...
import type { EnvelopeStatus, SignatureLevel, EnvelopeRoutingType } from '@prisma/generated/client.js';
import type {
  ...
  async update(
    ...
    const db = await prisma.signatureEnvelope.update({
      ...
      data: {
        ...
        ...(data.signedFileId !== undefined && { signedFileId: data.signedFileId }),
