...
export interface CreateEmployeeSchema {
  ...
  /**
   * Public short ID (Crockford-like, 6 chars) used by Emporion POS operator
   * login. Auto-generated by `CreateEmployeeUseCase` with bounded retry on
   * collision (Plan A — Task 21). Optional for backward compatibility with
...
export interface EmployeesRepository {
  ...
  /**
   * Finds an employee by their public short ID (Crockford-like, 6 chars).
   * Used by Emporion POS operator login + collision detection during
   * `Employee.create` (Plan A — Task 21). Tenant-scoped.
   */
  findByShortId(
    shortId: string,
    tenantId: string,
