...
export const ErrorCodes = {
  ...
  FINANCE_ESCALATION_NOT_FOUND: 'FINANCE_ESCALATION_NOT_FOUND',
  FINANCE_ESCALATION_DUPLICATE_NAME: 'FINANCE_ESCALATION_DUPLICATE_NAME',
  FINANCE_CHART_OF_ACCOUNT_NOT_FOUND: 'FINANCE_CHART_OF_ACCOUNT_NOT_FOUND',
  FINANCE_CHART_OF_ACCOUNT_IS_SYSTEM: 'FINANCE_CHART_OF_ACCOUNT_IS_SYSTEM',
  FINANCE_CHART_OF_ACCOUNT_HAS_CHILDREN:
    'FINANCE_CHART_OF_ACCOUNT_HAS_CHILDREN',
