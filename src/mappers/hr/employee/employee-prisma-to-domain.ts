...
export function mapEmployeePrismaToDomain(
  ...
  return {
    ...
    shortId: employeeDb.shortId ?? null,
    ...
    baseSalary:
      employeeDb.baseSalary != null ? Number(employeeDb.baseSalary) : undefined,
    ...
    isPregnant: employeeDb.isPregnant,
    pregnancyStartDate: employeeDb.pregnancyStartDate ?? undefined,
