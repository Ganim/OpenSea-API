...
export class FinanceEntry extends Entity<FinanceEntryProps> {
  ...
  set salesOrderId(value: string | undefined) {
    this.props.salesOrderId = value;
    this.touch();
  }
  ...
  set actualAmount(value: number | undefined) {
    this.props.actualAmount = value;
    this.touch();
  }
  ...
  set competenceDate(value: Date | undefined) {
  ...
  set paymentDate(value: Date | undefined) {
  ...
  get boletoDigitLine(): string | undefined {
    return this.props.boletoDigitLine;
  }
  ...
  get isOverdue(): boolean {
    if (['PAID', 'RECEIVED', 'CANCELLED'].includes(this.props.status))
      return false;
