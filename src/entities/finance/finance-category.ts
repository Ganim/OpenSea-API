...
export class FinanceCategory extends Entity<FinanceCategoryProps> {
  ...
  set slug(value: string) { this.props.slug = value; this.touch(); }
  ...
  set iconUrl(value: string | undefined) { this.props.iconUrl = value; this.touch(); }
  ...
  set type(value: string) { this.props.type = value; this.touch(); }
  ...
  set displayOrder(value: number) { this.props.displayOrder = value; this.touch(); }
  ...
  static create(
    props: Optional<FinanceCategoryProps, 'id' | 'createdAt' | 'updatedAt' | 'deletedAt' | 'isActive' | 'isSystem' | 'displayOrder'>,
    id?: UniqueEntityID,
  ): FinanceCategory {
