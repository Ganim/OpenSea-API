...
export class CostCenter extends Entity<CostCenterProps> {
  ...
  get companyId(): UniqueEntityID | undefined { return this.props.companyId; }
  set companyId(value: UniqueEntityID | undefined) { this.props.companyId = value; this.touch(); }
  ...
  set description(value: string | undefined) { this.props.description = value; this.touch(); }

  get isActive(): boolean { return this.props.isActive; }
  set isActive(value: boolean) { this.props.isActive = value; this.touch(); }

  get monthlyBudget(): number | undefined { return this.props.monthlyBudget; }
  set monthlyBudget(value: number | undefined) { this.props.monthlyBudget = value; this.touch(); }

  get annualBudget(): number | undefined { return this.props.annualBudget; }
  set annualBudget(value: number | undefined) { this.props.annualBudget = value; this.touch(); }

  get parentId(): UniqueEntityID | undefined { return this.props.parentId; }
  set parentId(value: UniqueEntityID | undefined) { this.props.parentId = value; this.touch(); }
  ...
  static create(
    props: Optional<CostCenterProps, 'id' | 'createdAt' | 'updatedAt' | 'deletedAt' | 'isActive'>,
    id?: UniqueEntityID,
  ): CostCenter {
