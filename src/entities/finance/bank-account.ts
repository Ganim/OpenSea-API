...
export class BankAccount extends Entity<BankAccountProps> {
  ...
  get agencyDigit(): string | undefined {
    return this.props.agencyDigit;
  }
  set agencyDigit(value: string | undefined) {
    this.props.agencyDigit = value;
    this.touch();
  }
  ...
  set accountDigit(value: string | undefined) {
    this.props.accountDigit = value;
    this.touch();
  }
  ...
  get balanceUpdatedAt(): Date | undefined {
    return this.props.balanceUpdatedAt;
  }
