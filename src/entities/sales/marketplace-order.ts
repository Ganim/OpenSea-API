...
export type MarketplaceOrderStatusType =
  | 'RECEIVED'
  | 'ACKNOWLEDGED'
  | 'PROCESSING'
  | 'SHIPPED'
...
export class MarketplaceOrder extends Entity<MarketplaceOrderProps> {
  ...
  get externalOrderUrl(): string | undefined {
    return this.props.externalOrderUrl;
  }
  get status(): MarketplaceOrderStatusType {
    return this.props.status;
  }
  set status(value: MarketplaceOrderStatusType) {
    this.props.status = value;
    this.touch();
  }
  get marketplaceStatus(): string | undefined {
    return this.props.marketplaceStatus;
  }
  get buyerName(): string {
    return this.props.buyerName;
  }
  get buyerDocument(): string | undefined {
    return this.props.buyerDocument;
  }
  ...
  get marketplaceFee(): number {
    return this.props.marketplaceFee;
  }
  ...
  set trackingCode(value: string | undefined) {
    this.props.trackingCode = value;
    this.touch();
  }
  get trackingUrl(): string | undefined {
    return this.props.trackingUrl;
  }
  set trackingUrl(value: string | undefined) {
    this.props.trackingUrl = value;
    this.touch();
  }
  get shippingLabel(): string | undefined {
    return this.props.shippingLabel;
  }
  ...
  get deliveryAddress(): Record<string, unknown> {
