...
export class Contact extends Entity<ContactProps> {
  ...
  set leadTemperature(value: string | undefined) {
    this.props.leadTemperature = value;
    this.touch();
  }
  ...
  set lastInteractionAt(value: Date | undefined) {
    this.props.lastInteractionAt = value;
    this.touch();
  }
  ...
  set lastChannelUsed(value: string | undefined) {
    this.props.lastChannelUsed = value;
    this.touch();
  }
  ...
  set socialProfiles(value: Record<string, unknown> | undefined) {
    this.props.socialProfiles = value;
    this.touch();
  }
  ...
  set isMainContact(value: boolean) {
    this.props.isMainContact = value;
    this.touch();
  }
