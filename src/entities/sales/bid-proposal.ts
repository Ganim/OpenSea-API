...
export type BidProposalStatusType =
  | 'DRAFT_PROPOSAL'
  | 'REVIEW_PROPOSAL'
  | 'APPROVED_PROPOSAL'
  | 'SENT_PROPOSAL'
...
export class BidProposal extends Entity<BidProposalProps> {
  ...
  get status(): BidProposalStatusType {
    return this.props.status;
  }
  set status(value: BidProposalStatusType) {
  ...
  get proposalFileId(): UniqueEntityID | undefined {
    return this.props.proposalFileId;
  }
  get sentAt(): Date | undefined {
    return this.props.sentAt;
  }
  get sentByUserId(): UniqueEntityID | undefined {
    return this.props.sentByUserId;
  }
  get sentByAi(): boolean {
    return this.props.sentByAi;
  }
  get portalConfirmation(): string | undefined {
    return this.props.portalConfirmation;
  }
  ...
  static create(
    props: Optional<
      BidProposalProps,
      'id' | 'createdAt' | 'status' | 'version' | 'sentByAi'
    >,
    id?: UniqueEntityID,
  ): BidProposal {
    return new BidProposal(
      {
        ...
        status: props.status ?? 'DRAFT_PROPOSAL',
        version: props.version ?? 1,
        sentByAi: props.sentByAi ?? false,
