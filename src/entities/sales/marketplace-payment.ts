...
export type MarketplacePaymentTypeValue =
  | 'SALE'
  | 'REFUND'
  | 'COMMISSION'
  | 'SHIPPING_FEE'
  ...
  | 'ADJUSTMENT'
  | 'TRANSFER';
export type MarketplacePaymentStatusType =
  | 'PENDING'
  | 'SETTLED'
  | 'DISPUTED'
  | 'CANCELLED';
...
export class MarketplacePayment extends Entity<MarketplacePaymentProps> {
  ...
  get type(): MarketplacePaymentTypeValue {
  ...
  get marketplaceOrderId(): string | undefined {
    return this.props.marketplaceOrderId;
  }
  get installmentNumber(): number | undefined {
    return this.props.installmentNumber;
  }
  get settlementDate(): Date | undefined {
    return this.props.settlementDate;
  }
  get status(): MarketplacePaymentStatusType {
    return this.props.status;
  }
  get financeEntryId(): string | undefined {
    return this.props.financeEntryId;
  }
