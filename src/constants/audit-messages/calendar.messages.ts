...
export const CALENDAR_AUDIT_MESSAGES = {
  ...
  PARTICIPANT_INVITE: {
    ...
    module: AuditModule.CALENDAR,
    description: '{{userName}} convidou participantes para o evento {{eventTitle}}',
  } satisfies AuditMessage,
  ...
  PARTICIPANT_RESPOND: {
    ...
    entity: AuditEntity.EVENT_PARTICIPANT,
    module: AuditModule.CALENDAR,
    description: '{{userName}} respondeu ao convite do evento {{eventTitle}} ({{status}})',
  } satisfies AuditMessage,
  ...
  PARTICIPANT_REMOVE: {
    ...
    entity: AuditEntity.EVENT_PARTICIPANT,
    module: AuditModule.CALENDAR,
    description: '{{userName}} removeu {{participantName}} do evento {{eventTitle}}',
  } satisfies AuditMessage,
  ...
  REMINDERS_MANAGE: {
    ...
    module: AuditModule.CALENDAR,
    description: '{{userName}} configurou lembretes para o evento {{eventTitle}}',
  } satisfies AuditMessage,
} as const;
