...
import { makeCreateCompanyStakeholderUseCase } from '@/use-cases/admin/company-stakeholder/factories';
...
describe('Delete Company Stakeholder (E2E)', () => {
  ...
  it('should delete company stakeholder with correct schema', async () => {
    ...
    const response = await request(app.server)
      .delete(`/v1/admin/companies/${companyId}/stakeholders/${stakeholder.id}`)
