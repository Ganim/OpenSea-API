...
import { makeDeleteCompanyFiscalSettingsUseCase } from '@/use-cases/admin/company-fiscal-settings/factories/make-company-fiscal-settings';
...
export async function deleteCompanyFiscalSettingsController(
  ...
  app.withTypeProvider<ZodTypeProvider>().route({
    method: 'DELETE',
    url: '/v1/admin/companies/:companyId/fiscal-settings',
    preHandler: [
      verifyJwt,
      verifyTenant,
    ...
    schema: {
      tags: ['Admin - Company Fiscal Settings'],
