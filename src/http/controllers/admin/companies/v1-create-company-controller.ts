...
export async function v1CreateCompanyAdminController(app: FastifyInstance) {
  app.withTypeProvider<ZodTypeProvider>().route({
    ...
    preHandler: [
      ...
      createPermissionMiddleware({
        permissionCode: PermissionCodes.ADMIN.COMPANIES.REGISTER,
        resource: 'companies',
      }),
    ],
    schema: {
      ...
      description: 'Creates a new company in the system (admin scope)',
