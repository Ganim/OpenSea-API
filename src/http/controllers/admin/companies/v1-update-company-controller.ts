...
} from '@/use-cases/admin/companies/factories/make-companies';
...
export async function v1UpdateCompanyAdminController(app: FastifyInstance) {
  app.withTypeProvider<ZodTypeProvider>().route({
    ...
    schema: {
      ...
      description:
        'Updates the information of an existing company (admin scope)',
      params: z.object({
        id: idSchema,
      }),
