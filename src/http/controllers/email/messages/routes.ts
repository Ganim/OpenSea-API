...
export async function emailMessagesRoutes(app: FastifyInstance) {
  ...
  app.withTypeProvider<ZodTypeProvider>().route({
    ...
    onRequest: [
      ...
      createPermissionMiddleware({
        permissionCode: PermissionCodes.TOOLS.EMAIL.MESSAGES.ACCESS,
  ...
  app.withTypeProvider<ZodTypeProvider>().route({
    ...
    onRequest: [
      ...
      verifyTenant,
      createPermissionMiddleware({
        permissionCode: PermissionCodes.TOOLS.EMAIL.MESSAGES.REGISTER,
        resource: 'email-messages',
      }),
    ],
    schema: {
  ...
  app.withTypeProvider<ZodTypeProvider>().route({
    ...
    onRequest: [
      ...
      verifyTenant,
      createPermissionMiddleware({
        permissionCode: PermissionCodes.TOOLS.EMAIL.MESSAGES.MODIFY,
        resource: 'email-messages',
      }),
    ],
    schema: {
  ...
  app.withTypeProvider<ZodTypeProvider>().route({
    ...
    onRequest: [
      ...
      verifyTenant,
      createPermissionMiddleware({
        permissionCode: PermissionCodes.TOOLS.EMAIL.MESSAGES.REMOVE,
        resource: 'email-messages',
      }),
    ],
    schema: {
