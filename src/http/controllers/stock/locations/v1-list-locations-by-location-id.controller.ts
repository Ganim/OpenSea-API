...
export async function listLocationsByLocationIdController(app: FastifyInstance) {
  app.withTypeProvider<ZodTypeProvider>().route({
    ...
    schema: {
      ...
      description: 'List all active sub-locations for a specific location with counts',
      security: [{ bearerAuth: [] }],
      params: z.object({
    ...
    handler: async (request, reply) => {
      ...
      const listLocationsByLocationIdUseCase = makeListLocationsByLocationIdUseCase();
