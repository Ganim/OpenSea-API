...
import { idSchema, absenceResponseSchema, approveAbsenceSchema } from '@/http/schemas';
...
export async function v1ApproveAbsenceController(app: FastifyInstance) {
    ...
    handler: async (request, reply) => {
      ...
      try {
        ...
        await logAudit(request, {
          message: AUDIT_MESSAGES.HR.ABSENCE_APPROVE,
          entityId: absenceId,
          placeholders: {
            userName: userId,
