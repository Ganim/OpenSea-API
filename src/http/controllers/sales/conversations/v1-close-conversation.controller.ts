...
import { makeCloseConversationUseCase } from '@/use-cases/sales/conversations/factories/make-close-conversation-use-case';
...
export async function closeConversationController(app: FastifyInstance) {
  app.withTypeProvider<ZodTypeProvider>().route({
    ...
    schema: {
      ...
      summary: 'Close a conversation (OPEN -> CLOSED)',
    ...
    handler: async (request, reply) => {
      ...
      try {
        ...
        const useCase = makeCloseConversationUseCase();
        ...
        await logAudit(request, {
          message: AUDIT_MESSAGES.SALES.CONVERSATION_CLOSE,
