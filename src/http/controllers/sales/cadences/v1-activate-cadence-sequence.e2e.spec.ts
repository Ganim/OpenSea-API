...
describe('Activate Cadence Sequence (E2E)', () => {
  let tenantId: string;
  ...
  it('should activate a cadence sequence (200)', async () => {
    ...
    expect(response.body.cadenceSequence.isActive).toBe(true);
  });
});
