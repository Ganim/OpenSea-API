...
export async function getFolderActivityController(app: FastifyInstance) {
  app.withTypeProvider<ZodTypeProvider>().route({
    method: 'GET',
    url: '/v1/storage/folders/:id/activity',
    preHandler: [
      verifyJwt,
      verifyTenant,
    ...
    schema: {
      ...
      summary: 'Get activity log for a folder',
      description:
        'Returns audit log entries for a specific folder (create, rename, move, delete, access changes).',
      params: z.object({
        id: z.string().uuid(),
      }),
