...
export class ListBidContractsUseCase {
  ...
  async execute(request: ListBidContractsUseCaseRequest): Promise<ListBidContractsUseCaseResponse> {
    const result: PaginatedResult<BidContract> = await this.bidContractsRepository.findManyPaginated({
