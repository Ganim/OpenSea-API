...
let sut: ForceActionPinResetUseCase;

describe('ForceActionPinResetUseCase', () => {
  beforeEach(() => {
    usersRepository = new InMemoryUsersRepository();
    sut = new ForceActionPinResetUseCase(usersRepository);
  });

  it('should force action PIN reset successfully', async () => {
    ...
    expect(updatedUser?.forceActionPinSetup).toBe(true);
  });
